#include <pgmspace.h>
const unsigned char hz_weekday PROGMEM[] =
{
...
const unsigned char hz_guang PROGMEM[] = 
{
 0x01,0x00,0x00,0x80,0x00,0x80,0x3F,0xFC,0x20,0x00,0x20,0x00,0x20,0x00,0x20,0x00 ,
 0x20,0x00,0x20,0x00,0x20,0x00,0x20,0x00,0x20,0x00,0x40,0x00,0x40,0x00,0x80,0x00/*"广",0*/
...
{
  {"周", hz_weekday,16}, {"一", hz_Mon,16}, {"二", hz_Tue,16}, {"三", hz_Wed,16}, {"四", hz_Thu,16},
  {"五", hz_Fri,16}, {"六", hz_Sat,16}, {"日", hz_Sunday,16}, {"晴", hz_sun,16}, {"阴", hz_cloudy,16},
  {"雨", hz_rain,16}, {"雪", hz_snow,16}, {"多", hz_duo,16}, {"云", hz_yun,16}, {"广", hz_guang,16}, {"州", hz_zhou, 16},
